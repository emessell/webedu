...
<div class="container">
  ...
  <ul class="pagination">
    <li class="page-item"><input type="submit" class="page-link" value="수정" /></li>
    <li class="page-item"><a class="page-link" href="/webedu/bbs/view.do?bNum=${view.getbNum() }">수정</a></li>
  </ul>
  </form>
</nav>
</div>
