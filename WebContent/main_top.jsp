...
<style>
  *{margin: 0; text-align: center;}
  ...
  #header1{background-color: rgb(186, 113, 54); height: 10%;}
  ...
  #footer2 {position: fixed; height:10%; width: 100%; background-color: red; color: white; text-align: center;}
  #p1{height: 65%;}
  .topnav {overflow: hidden;background-color: #333;}
  .topnav a {float: left;color: #f2f2f2;text-align: center; padding: 1.8% 20px ; text-decoration: none;font-size: 17px;}
