...
#section2 {
	background-color: rgb(60, 26, 185);
	width: 70%;
	height: 40%;
	float: left;
}
...
#article {
	background-color: rgb(20, 224, 52);
	width: 30%;
	height: 20%;
	float: right;
}
...
#aside {
	background-color: rgb(45, 71, 167);
	width: 30%;
	height: 50%;
	float: right;
}
...
#header2 {
	background-color: rgb(123, 176, 40);
	height: 10%;
}

#footer1 {
	background-color: rgb(176, 150, 40);
	height: 10%;
}
...
<body>
	...
	<nav id="nav" class="topnav">
		...
		<a href="/webedu/bbs/list.do" target="iframe_content">글 목록</a>
	</nav>
</body>
</html>