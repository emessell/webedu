...
<body>
 ...
 --%>
	<p>
		이름:
		<jsp:getProperty property="name" name="member"></jsp:getProperty></p>
	<p>
		아이디:
		<jsp:getProperty property="id" name="member"></jsp:getProperty></p>
	<p>
		비밀번호:
		<jsp:getProperty property="passwd" name="member"></jsp:getProperty></p>
	<hr></hr>
	이름 : ${member.name }
	<br /> 아이디 : ${member.id }
	<br /> 비밀번호 : ${member.passwd }
	<br />
</body>
</html>